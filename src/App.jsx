...
.pin-pad{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;max-width:242px;margin:0 auto}
.pk{aspect-ratio:1/1;background:var(--s2);border:1px solid var(--b1);border-radius:var(--rsm);
